...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Country firstAnswer = Country.countryWithHighestCH4InYear(countries, 2000);

        System.out.println("Which country had the highest methane gas emissions in 2000? " +
                firstAnswer.getName().toUpperCase() + "\n");

        Country secondAnswer = Country.countryWithHighestChangeInEmissions(countries, 1988, 2012);
        System.out.println("Which country had the highest increase in greenhouse gas " +
                "emissions between 1988 (the year the Intergovernmental Panel \n" +
                "on Climate Change was formed) and 2012? " + secondAnswer.getName().toUpperCase() + "\n");

        Sector thirdAnswer = Sector.sectorWithHighestAverageEmissions(sectors, 1988, 2012);
        System.out.println("Which sector had the highest change in greenhouse gas emissions \n" +
                "between 1988 and 2012? " + thirdAnswer.getName().toUpperCase() + "\n");
